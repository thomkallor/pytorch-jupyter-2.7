...
* [CUDA 7.0](https://developer.nvidia.com/cuda-toolkit) (GPU version only for tensorflow 0.6.0)
* [cuDNN v6.5](https://developer.nvidia.com/cudnn) (GPU version only for tensorflow 0.6.0)
...
```bash
git clone https://github.com/thomkallor/pytorch-jupyter-2.7/
cd dl-docker
```	
...
### Jupyter Notebooks
*Please use the token generated to log into jupyter
